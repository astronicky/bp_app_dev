/*
 * Created by Justice on Tue Dec 08 2020
 *
...
class FeedGifSearchComponent extends Component {
    render() {
...
export default connect(null, mapDispatchToProps)(withTheme(FeedGifSearchComponent))
